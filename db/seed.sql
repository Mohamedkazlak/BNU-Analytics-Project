...
insert into people (id, full_name, email) values
  ('p-priya-raman', 'Prof. Dr. Tamer Samir', 'tamer.samir@bnu.edu.eg'),
  ('p-karim-fawzy', 'Prof. Dr. Hussein Mahmoud', 'hussein.mahmoud@bnu.edu.eg'),
  ('p-hana-elmasry', 'Dr. Hana El-Masry', 'hana.el.masry@bnu.edu.eg'),
  ('p-nadia-elsherif', 'Prof. Dr. Nadia El-Sherif', 'nadia.el.sherif@bnu.edu.eg'),
  ('p-khaled-mansour', 'Prof. Dr. Khaled Mansour', 'khaled.mansour@bnu.edu.eg'),
  ('p-daniel-osei', 'Prof. Dr. Eman Abdel-elghaffar', 'eman.abdel.elghaffar@bnu.edu.eg'),
  ('p-mohamed-mostafa', 'Prof. Dr. Mohamed Mostafa', 'mohamed.mostafa@bnu.edu.eg'),
  ('p-mahmoud-el-toukhy', 'Prof. Dr. Mahmoud El-Toukhy', 'mahmoud.el.toukhy@bnu.edu.eg'),
  ('p-ashraf-ismail', 'Prof. Dr. Ashraf Ismail', 'ashraf.ismail@bnu.edu.eg'),
  ('p-heba-mahmoud', 'Prof. Dr. Heba Mahmoud', 'heba.mahmoud@bnu.edu.eg'),
  ('p-asmaa-mahmoud', 'Prof. Dr. Asmaa Mahmoud', 'asmaa.mahmoud@bnu.edu.eg'),
  ('p-ahmed-hassan', 'Prof. Dr. Ahmed Hassan', 'ahmed.hassan@bnu.edu.eg'),
  ('p-ghada-mohamed', 'Prof. Dr. Ghada Mohamed', 'ghada.mohamed@bnu.edu.eg'),
  ('p-doaa-aakl', 'Prof. Dr. Doaa Aakl', 'doaa.aakl@bnu.edu.eg'),
  ('p-sara-mansour', 'Sara Mansour', 'sara.mansour@bnu.edu.eg'),
  ('p-dina-farouk', 'Dina Farouk', 'dina.farouk@bnu.edu.eg'),
  ('p-omar-khalil', 'Omar Khalil', 'omar.khalil@bnu.edu.eg'),
  ('p-rania-hassan', 'Rania Hassan', 'rania.hassan@bnu.edu.eg'),
  ('p-mostafa-adel', 'Mostafa Adel', 'mostafa.adel@bnu.edu.eg'),
  ('p-nourhan-saleh', 'Nourhan Saleh', 'nourhan.saleh@bnu.edu.eg'),
  ('p-hossam-ali', 'Hossam Ali', 'hossam.ali@bnu.edu.eg'),
  ('p-laila-magdy', 'Laila Magdy', 'laila.magdy@bnu.edu.eg'),
  ('p-yasmine-fathy', 'Yasmine Fathy', 'yasmine.fathy@bnu.edu.eg'),
...
insert into staff (person_id, title, org_unit_id) values
  ...
  ('p-karim-fawzy', 'Vice President for Academic Affairs', 'uni-bnu'),
  ('p-hana-elmasry', 'Dean, Engineering and Basic & Applied Sciences', 'sec-engineering'),
  ('p-nadia-elsherif', 'Dean, Health Sciences Sector', 'sec-health'),
  ('p-khaled-mansour', 'Dean, Literature, Arts and Humanities Sector', 'sec-humanities'),
  ('p-daniel-osei', 'Program Director, Computer Science', 'prog-computer-science'),
  ('p-mohamed-mostafa', 'Program Director, Energy Sciences', 'prog-energy-sciences'),
  ('p-mahmoud-el-toukhy', 'Program Director, Engineering', 'prog-engineering'),
  ('p-ashraf-ismail', 'Program Director, Medicine', 'prog-medicine'),
  ('p-heba-mahmoud', 'Program Director, Dentistry', 'prog-dentistry'),
  ('p-asmaa-mahmoud', 'Program Director, Physical Therapy', 'prog-physical-therapy'),
  ('p-ahmed-hassan', 'Program Director, Veterinary', 'prog-veterinary'),
  ('p-ghada-mohamed', 'Program Director, Visual Arts and Design', 'prog-visual-arts'),
  ('p-doaa-aakl', 'Program Director, Economics and Business Administration', 'prog-economics'),
  ('p-sara-mansour', 'Academic Affairs Officer, Computer Science', 'prog-computer-science'),
  ('p-dina-farouk', 'Academic Affairs Officer, Energy Sciences', 'prog-energy-sciences'),
  ('p-omar-khalil', 'Academic Affairs Officer, Engineering', 'prog-engineering'),
  ('p-rania-hassan', 'Academic Affairs Officer, Medicine', 'prog-medicine'),
  ('p-mostafa-adel', 'Academic Affairs Officer, Dentistry', 'prog-dentistry'),
  ('p-nourhan-saleh', 'Academic Affairs Officer, Physical Therapy', 'prog-physical-therapy'),
  ('p-hossam-ali', 'Academic Affairs Officer, Veterinary', 'prog-veterinary'),
  ('p-laila-magdy', 'Academic Affairs Officer, Visual Arts and Design', 'prog-visual-arts'),
  ('p-yasmine-fathy', 'Academic Affairs Officer, Economics and Business Administration', 'prog-economics'),
  ('p-tomas-oyelaran', 'Professor of Computer Science', 'prog-computer-science'),
  ('p-layla-nasser', 'Academic Integrity', 'uni-bnu'),
...
insert into user_accounts (id, person_id, role, scope_id, student_id, is_demo) values
  ...
  ('u-dean-health', 'p-nadia-elsherif', 'senior_management', 'sec-health', null, true),
  ('u-dean-hum', 'p-khaled-mansour', 'senior_management', 'sec-humanities', null, true),
  ('u-pd-cs', 'p-daniel-osei', 'program_director', 'prog-computer-science', null, true),
  ('u-pd-ene', 'p-mohamed-mostafa', 'program_director', 'prog-energy-sciences', null, true),
  ('u-pd-eng', 'p-mahmoud-el-toukhy', 'program_director', 'prog-engineering', null, true),
  ('u-pd-med', 'p-ashraf-ismail', 'program_director', 'prog-medicine', null, true),
  ('u-pd-den', 'p-heba-mahmoud', 'program_director', 'prog-dentistry', null, true),
  ('u-pd-pt', 'p-asmaa-mahmoud', 'program_director', 'prog-physical-therapy', null, true),
  ('u-pd-vet', 'p-ahmed-hassan', 'program_director', 'prog-veterinary', null, true),
  ('u-pd-art', 'p-ghada-mohamed', 'program_director', 'prog-visual-arts', null, true),
  ('u-pd-eco', 'p-doaa-aakl', 'program_director', 'prog-economics', null, true),
  ('u-aa-cs', 'p-sara-mansour', 'academic_affairs', 'prog-computer-science', null, true),
  ('u-aa-ene', 'p-dina-farouk', 'academic_affairs', 'prog-energy-sciences', null, true),
  ('u-aa-eng', 'p-omar-khalil', 'academic_affairs', 'prog-engineering', null, true),
  ('u-aa-med', 'p-rania-hassan', 'academic_affairs', 'prog-medicine', null, true),
  ('u-aa-den', 'p-mostafa-adel', 'academic_affairs', 'prog-dentistry', null, true),
  ('u-aa-pt', 'p-nourhan-saleh', 'academic_affairs', 'prog-physical-therapy', null, true),
  ('u-aa-vet', 'p-hossam-ali', 'academic_affairs', 'prog-veterinary', null, true),
  ('u-aa-art', 'p-laila-magdy', 'academic_affairs', 'prog-visual-arts', null, true),
  ('u-aa-eco', 'p-yasmine-fathy', 'academic_affairs', 'prog-economics', null, true),
  ('u-prof-cs', 'p-tomas-oyelaran', 'professor', 'prog-computer-science', null, true),
  ('u-prof-ene', 'p-yasser-mansour', 'professor', 'prog-energy-sciences', null, true),
  ('u-prof-eng', 'p-hana-elmasry', 'professor', 'prog-engineering', null, true),
  ('u-prof-med', 'p-yasmin-adel', 'professor', 'prog-medicine', null, true),
  ('u-prof-den', 'p-walid-naguib', 'professor', 'prog-dentistry', null, true),
  ('u-prof-pt', 'p-amira-saleh', 'professor', 'prog-physical-therapy', null, true),
  ('u-prof-vet', 'p-nabil-youssef', 'professor', 'prog-veterinary', null, true),
  ('u-prof-art', 'p-lina-haddad', 'professor', 'prog-visual-arts', null, true),
  ('u-prof-eco', 'p-nour-elsayed', 'professor', 'prog-economics', null, true),
  ('u-it-integrity', 'p-layla-nasser', 'it_academic_integrity', 'uni-bnu', null, true),
